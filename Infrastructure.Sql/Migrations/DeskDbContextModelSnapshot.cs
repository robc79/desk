...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Desk.Domain.Entities.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Desk.Domain.Entities.Item", b =>
                {
                    b.HasOne("Desk.Domain.Entities.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("ItemTags", b =>
                {
                    b.HasOne("Desk.Domain.Entities.Item", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Desk.Domain.Entities.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Desk.Domain.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Desk.Domain.Entities.User", null)
                        .WithMany()
